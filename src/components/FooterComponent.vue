...
import { getSitemaps } from '@/services/api.js'
...
const siteMaps = reactive({ items: <SiteMaps[]>[] })
...
const selectedSiteMaps = reactive({item: {}});
...
<template>
    ...
    <div class="mx-6 py-10 text-center md:text-left">
        ...
        <div class="my-auto">
            <ul class="list-none mb-0">
            <li v-for="(sitemap, i) in siteMaps.items" :key="i">
               <button @click="handleSelect(sitemap)" ref="siteMaps" class="underline text-gray-600">{{ sitemap.name }}</button>
            </li>
            </ul>
        </div>

        <div class="my-auto">
            <h5 class="justify-center flex md:justify-start uppercase font-bold">Media</h5>
                <div class="justify-center flex md:justify-start  space-x-4 mt-2"> 
                ...
                <div class="justify-center flex md:justify-start  space-x-4 mt-3">
                    <a class="text-gray-600">
